...
<form action="form/spk/simpan_nilai.php" method="post" enctype="multipart/form-data">
	    ...
	    <?php echo $djb['nama_jenis_bantuan'] ?>
              ...
              <div class="form-group">
              	...
              	<select name="<?php echo $value['id_kriteria'] ?>" class="form-control">
              		...
              		<option value="<?php echo $d_pilihan['id_pilihan'] ?>"><?php echo $d_pilihan['nama_pilihan'] ?></option>
						<?php } ?>
              	</select>
