...
$q_user = mysqli_query($conn, "SELECT * from user where id_user='$id_user'");
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="hidden" class="form-control" required readonly name="id_user" value="<?php echo $d_user['id_user'] ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" required value="<?php echo $d_user['username'] ?>"  name="username">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="password" class="form-control" required value="<?php echo $d_user['password'] ?>"  name="password">
