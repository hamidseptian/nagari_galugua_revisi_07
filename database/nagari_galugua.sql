...
INSERT INTO `kk` (`id_kk`, `no_kk`, `kepala_keluarga`) VALUES
(4, '1232', '1371111009940013300'),
(14, '53452352', '42342457'),
(15, '43634534', '42342454'),
(16, '795673', '42342461'),
(17, '45645643', '42342456'),
(18, '7856845', '42342466'),
(19, '87856754', '42342465'),
(20, '85745', '42342468'),
(21, '75745745', '42342463'),
(22, '97865', '42342469');
...
INSERT INTO `mitra` (`id_mitra`, `nama_toko`, `pemilik_toko`, `alamat_toko`, `nohp_toko`, `username`, `password`, `status`) VALUES
...
INSERT INTO `penduduk` (`id_penduduk`, `nik`, `nama`, `tmpl`, `tgll`, `jk`, `alamat`, `rt`, `rw`, `kelurahan`, `kecamatan`, `agama`, `status_perkawinan`, `pekerjaan`, `kewarganegaraan`, `berlaku_hingga`, `password`) VALUES
...
(3, '1371111009', 'Hamid Septian', 'padang', '1995-09-18', 'P', 'maransi', '001', '005', 'Air P', 'Koto ', 'Hindu', 'Belum Kawin', 'Programmer', 'WNA', '2021-04-23', ''),
(4, '1234', 'Hamid Septian', 'padang', '1995-09-18', 'P', 'maransi', '001', '005', 'Air P', 'Koto ', 'Hindu', 'Belum Kawin', 'Programmer', 'WNA', '2021-04-23', ''),
...
(26, '42342470', 'Elfi Hendrayeti', 'KAMPUNG BARU', '1971-06-01', 'P', 'Disana', '017', '017', 'Disana', 'Disana', 'islam', 'nikah', 'ojol', 'indo', '2020-09-25', ''),
...
(5, '', 'sate', '', 15000, '210315062948hotel.PNG'),
(7, '', 'Cendol', '', 8000, '210411115349mapala1.jpg'),
(8, '', 'Beras', 'Kilo', 90000, '210417101636fokis.jpg'),
(9, '', 'padi', 'Kilo', 900000, '210419033151mapala3.jpg'),
(11, '2', 'Makanan', 'Kilo', 400000, '210618105326padi.jpg'),
(12, '3', 'Sate', 'Kilo', 80000, '210619120132padi.jpg'),
(13, '3', 'beras', 'Kilo', 3443654, '210619120145padi.jpg');
...
INSERT INTO `user` (`id_user`, `id_pn`, `nama_user`, `username`, `password`, `level`) VALUES
(7, '4', 'Debi Kifah Anggela', '123', '123', 'Admin');
...
--
ALTER TABLE `detail_kk`
  MODIFY `id_detail_kk` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jenis_bantuan`
--
ALTER TABLE `jenis_bantuan`
  MODIFY `id_jenis_bantuan` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `kk`
--
ALTER TABLE `kk`
  MODIFY `id_kk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `penduduk`
  MODIFY `id_penduduk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
